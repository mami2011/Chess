...
/**
 * MercadolibreCategoryAttributes generated by hbm2java
 */
@Entity
@Table(name = "mercadolibre_category_attributes", catalog = "stool")
public class MercadolibreCategoryAttributes implements java.io.Serializable {
	...
	public MercadolibreCategoryAttributes() {
	}

	public MercadolibreCategoryAttributes(int categoryId) {
		this.categoryId = categoryId;
	}

	public MercadolibreCategoryAttributes(int categoryId,
			String meliAttributeId, String meliAttributeName,
			String meliAttributeType, Boolean required) {
		this.categoryId = categoryId;
