...
/**
 * MercadolibreCategories generated by hbm2java
 */
@Entity
@Table(name = "mercadolibre_categories", catalog = "stool")
public class MercadolibreCategories implements java.io.Serializable {
	...
	public MercadolibreCategories() {
	}

	public MercadolibreCategories(boolean hasAttributes, String rootId,
	...
	public MercadolibreCategories(String meliCategoryId,
			String meliCategoryName, String siteId, boolean hasAttributes,
			String rootId, String listingAllowed, String buyingAllowed) {
